...
EN_RESULT AtmelAtsha204a_Wake(bool verifyDeviceIsAtmelAtsha204a)
{
    ...
    do {
        ...
        actualResponse = ByteArrayToUnsignedInt32((uint8_t*)&readBuffer);
    } while (expectedResponse != actualResponse);
                              ...
                              uint8_t* pReadData)
{
    ...
    usleep(ATMEL_ATSHA204A_READ_EXECUTION_TIME_MILLISECONDS*1000);
#endif
